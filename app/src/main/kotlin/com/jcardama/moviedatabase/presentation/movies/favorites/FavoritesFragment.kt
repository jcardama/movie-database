package com.jcardama.moviedatabase.presentation.movies.favorites
...
import kotlinx.android.synthetic.main.fragment_favorite_movies.view.empty_layout
import kotlinx.android.synthetic.main.fragment_favorite_movies.view.progress_bar
import kotlinx.android.synthetic.main.fragment_favorite_movies.view.recycler_view
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.recycler_view.initAdapter<MovieEntity>(R.layout.item_movie).onBindView { itemView, item, _ ->
            ...
            itemView.favorite_image_view.setOnClickListener {
                item?.favorite = false
                Toast.makeText(requireContext(), R.string.message_movie_removed_from_favorites, Toast.LENGTH_LONG).show()
