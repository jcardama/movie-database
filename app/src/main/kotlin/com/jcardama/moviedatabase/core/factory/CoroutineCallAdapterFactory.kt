...
package com.jcardama.moviedatabase.core.factory
 ...
 *     interface MyService {
 *       &#64;GET("user/me")
 *       Deferred&lt;MovieModel&gt; getPending()
 *     }
 *
 * There are two configurations supported for the [Deferred] type parameter:
 *
 * * Direct body (e.g., `Deferred<MovieModel>`) returns the deserialized body for 2XX responses, throws
 * [HttpException] errors for non-2XX responses, and throws [IOException][java.io.IOException] for
 * network errors.
 * * Response wrapped body (e.g., `Deferred<Response<MovieModel>>`) returns a [Response] object for all
