...
fun Context.sharedPreferences(
    fileName: String? = null, function: (SharedPreferences.Editor.() -> Unit)
) {
...
fun <T> Context.getFromSharedPreferences(
    ...
    val sharedPreferences = when {
        fileName.isNullOrEmpty() -> getSharedPreferences(DEFAULT_SHARED_PREFERENCES_FILE_NAME, Context.MODE_PRIVATE)
