...
package com.jcardama.moviedatabase.util.factory
 ...
 *     interface MyService {
 *       &#64;GET("user/me")
 *       Deferred&lt;Movie&gt; getPending()
 *     }
 *
 * There are two configurations supported for the [Deferred] type parameter:
 *
 * * Direct body (e.g., `Deferred<Movie>`) returns the deserialized body for 2XX responses, throws
 * [HttpException] errors for non-2XX responses, and throws [IOException][java.io.IOException] for
 * network errors.
 * * Response wrapped body (e.g., `Deferred<Response<Movie>>`) returns a [Response] object for all
